    ...
    <div class="chart-div title02" ></div>
      <!-- <figure class="right" ref="left">
        ...
        <div class="content-wrap">
             <p>绝大多数的上海民众都是按照4月1日起封城5天的通知准备物资。但到了4日晚上，愈演愈烈的疫情让大家意识到，可能不会如期解封了。</p>
               <p>果然，“封城”被不断推迟，但大家的囤粮也逐渐难以维持基本生活需求了。</p>
              <p>由于前期囤货不足，自疫情封控以来，民众获取食材等物资的方式主要有三种：<br/>
              各区政府将援助物资通过街道和居委会发放到住户；<br/>
              居委会寻找供货商，统一采购和配送到所属小区内的住户；<br/>
      ...
      <article >
          ...
          <div :class="'s step top step-'+id" data-step="1">
              ...
              <p>问卷调查中，77.5%的受访者有通过社区团购的方式购买食材的经历。同时，在上述1517条饮食相关的求助信息中，有50.5%的问题都与“团购”有关。也就是说，团购是上海民众现阶段最常用的获取物资方式，但在打通该渠道的过程中又困难重重。</p>
                </div>
              </div>
          </div>
          ...
          <div :class="'step step-'+id" data-step="2">
              <div class="right slide-bar">
                <div>
                  ...
                  <p>他们受限于无法接触到团购渠道。一方面是找不到相应的供货商，或者缺乏有力的“团长”带头组织，也有些居民区因为人口密度低，凑不起来团购的起送规模；另一方面，由于团购前需报备给居委会同意，但并不是所有社区都可以承担物流的消杀和住户安全保障的工作。 </p>
          ...
          <div :class="'lll step step-'+id" data-step="3">
              <div class="right slide-bar">
                <div>
                    ...
                    <p>就连呼救，都需要他人代发。尽管如此，我们还是可以从中捕捉到总占比相当高的老人求助信息。</p>
                    <p>与此同时，另有14.8%的求助者表示：起初很多地区没有重视外来物资的消杀环节，从而引发多起“物传人”的疫情扩散。由于担心物资携带病毒引发传染和食品安全问题得不到保障，不敢参与网上的团购。</p>
          ...
          <div :class="'ll step step-'+id" data-step="4">
              <div class="right slide-bar">
                <div>
                  ...
                  <p>据某平台骑手估算，自己平均每天要在外面跑14个小时，接20来单，单程都在20公里左右。即使这样，仍然有大量需求无法满足。可见，运力不足也是封城期间诸多地方食物供应瘫痪的重要原因。
                  </p>
